...
При сохранении ноутбуков из Google Colab сохраняем ноутбуки в директории notebooks. И не забываем делать регулярные коммиты, чтобы избежать потери данных.
